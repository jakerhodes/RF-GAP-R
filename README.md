...
observations. This is done by using the argument $x\_test$. The returned
proximity matrix will have $n\_train + n\_test$ rows and columns. The
returned proximity matrix is an S3 object of type $rf\_proximities$.
...
```
    ...
    ## initial  value 15.892649 
    ## iter   5 value 8.475449
    ## iter  10 value 7.966753
    ## final  value 7.954306 
    ## converged
...
$rf\_proximities$ object is supplied. Additionally, the user may provide
a pretrained $ranger$ if $x$ is the data matrix, rather than a proximity
matrix. $rf\_outliers$ returns an object of S3 type $rf\_outlier$ which
is an array of the length of the number of objects in the dataset $x$.
...
```
    ...
    ## initial  value 16.260033 
    ## iter   5 value 13.532308
    ## iter  10 value 12.666733
    ## iter  15 value 12.469404
    ## iter  15 value 12.461744
    ## final  value 12.437736 
    ## converged
